    ...
    <motion.div data-testid="customers-page" initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.3 }}>
      ...
      <div className="card overflow-hidden">
        ...
        <div className="hidden md:block overflow-x-auto">
          ...
          <tbody>
            {loading ? (<tr><td colSpan={canReassign ? 8 : 7} className="text-center py-12 text-[#71717A]">{t('loading')}</td></tr>
            ) : customers.length === 0 ? (<tr><td colSpan={canReassign ? 8 : 7} className="text-center py-12 text-[#71717A]">{t('noCustomers')}</td></tr>
