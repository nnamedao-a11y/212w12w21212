  ...
  return (
    ...
    >
      ...
      <div className="flex items-start justify-between gap-3">
        <div className="min-w-0 flex-1">
          <h1
            className="text-lg sm:text-2xl md:text-3xl font-bold tracking-tight text-[#18181B] leading-tight break-words"
            style={{ fontFamily: 'Mazzard, Mazzard H, Mazzard M, system-ui, sans-serif' }}
          >
            {t('adm_vin_parser_control_center')}
          </h1>
          <p className="text-[11.5px] sm:text-sm text-[#71717A] mt-1 flex flex-wrap items-center gap-x-1.5 gap-y-0.5">
            <span>
