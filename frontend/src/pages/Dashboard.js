    ...
    >
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-6 lg:mb-8">
        <div className="flex-1 min-w-0">
          <h1 className="text-xl sm:text-2xl font-bold tracking-tight text-[#18181B] break-words" style={{ fontFamily: 'Mazzard, Mazzard H, Mazzard M, system-ui, sans-serif' }}>
            {t('controlPanel')}
          </h1>
      ...
      <div className="mb-5 sm:mb-6 rounded-2xl border border-[#E4E4E7] bg-white p-4 sm:p-5" data-testid="my-operational-queue">
        <div className="flex items-center justify-between gap-3 mb-3">
          <div className="min-w-0">
            ...
            >
              {t('my_operational_queue') === 'my_operational_queue' ? 'My operational queue' : t('my_operational_queue')}
            </h2>
            <p className="text-[11px] sm:text-xs text-[#A1A1AA] mt-0.5">
              {myQueue.loaded
                ? (myQueueTotal > 0
                    ? `${myQueueTotal} item(s) waiting on you right now`
