...
const TABS = [
  ...
  { id: 'sms',     label: 'SMS outbox',   icon: DeviceMobile },
  { id: 'ai',      label: 'AI · OpenAI',  icon: Brain },
];
            ...
            <div className="space-y-4">
              <div>
                ...
                <p className="text-xs sm:text-sm text-gray-500 mt-1">
                  Системный AI-провайдер. API-ключ + модель используются всеми
                  AI-фичами BIBI (классификация лидов, генерация описаний, чат).
                </p>
              </div>
